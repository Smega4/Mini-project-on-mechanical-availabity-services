    ...
    <div class="container">
        <table border="1">
            ...
            try {
                ...
                // Prepare the SQL query to fetch data from the table where yearsOfService is "Water Purifier Service"
                String query = "SELECT firstName, lastName, phoneNumber, location, state FROM registers WHERE yearsOfService = 'Water Purifier Service'";
